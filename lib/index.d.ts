...
declare class IdToken {
  constructor(
    ...
    context?: { ctx?: KoaContextWithOIDC | undefined; client?: Client | undefined }
  );
...
export interface Configuration {
    ...
    | {
        ...
        fapi?:
          | {
              ...
              profile?:
                | FapiProfile
                | ((ctx: KoaContextWithOIDC, client: Client) => FapiProfile)
                | undefined;
            }
          | undefined;
        ...
        rpInitiatedLogout?:
          | {
              ...
              postLogoutSuccessSource?:
                ...
                | undefined; // tslint:disable-line:void-return
              logoutSource?:
                | ((ctx: KoaContextWithOIDC, form: string) => CanBePromise<undefined | void>)
                | undefined; // tslint:disable-line:void-return
            }
          | undefined;
        ...
        resourceIndicators?:
          | {
              ...
              getResourceServerInfo?:
                ...
                | undefined;
              defaultResource?:
                | ((ctx: KoaContextWithOIDC) => CanBePromise<string | string[]>)
                | undefined;
              useGrantedResource?:
                | ((
                    ctx: KoaContextWithOIDC,
  ...
  interactions?:
    | {
        ...
        url?:
          | ((ctx: KoaContextWithOIDC, interaction: Interaction) => CanBePromise<string>)
          | undefined;
      }
    | undefined;
...
export namespace helpers {
    function pushScriptSrcSha(ctx: Koa.Context, script: string): string;
    function htmlSafe(input: unknown): string;
    function foo(): string;
}
